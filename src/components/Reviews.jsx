                ...
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Omar Reda</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Nedaa Hamed</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Noura Nabil</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Ahmed Hatem</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
            </div>
